 ...
 */
var assets = {
  no1: 'src/openDataContext/assets/no1.png',
  no2: 'src/openDataContext/assets/no2.png',
  no3: 'src/openDataContext/assets/no3.png',
  next: 'src/openDataContext/assets/next.png',
  last: 'src/openDataContext/assets/last.png',
  avatar: 'src/openDataContext/assets/avatar.png',
  panel: 'src/openDataContext/assets/panel.png',
};
/**
 * canvas 大小
 * 这里暂时写死
...
let mockData = [
  {
    KVDataList: [{key: 'score', value: '99999'}],
    avatarUrl: url,
    nickname: '你好你好你好你好',
    openid: 'kjshfdjkdshkjsdh',
  },
  {
    KVDataList: [{key: 'score', value: '43'}],
    avatarUrl: url,
    nickname: 'fdgdg',
    openid: 'kjshfdjkdshkjsdh',
  },
  {
    KVDataList: [{key: 'score', value: '543'}],
    avatarUrl: url,
    nickname: 'ff',
    openid: 'kjshfdjkdshkjsdh',
  },
  {
    KVDataList: [{key: 'score', value: '45'}],
    avatarUrl: url,
    nickname: 'dfg',
    openid: 'kjshfdjkdshkjsdh',
  },
  ...
  {
    KVDataList: [{key: 'score', value: '456'}],
    avatarUrl: url,
    nickname: 'gf',
    openid: 'kjshfdjkdshkjsdh',
  },
  {
    KVDataList: [{key: 'score', value: '66'}],
    avatarUrl: url,
    nickname: 'fggg',
    openid: 'kjshfdjkdshkjsdh',
  },
  {
    KVDataList: [{key: 'score', value: '435'}],
    avatarUrl: url,
    nickname: 'dfgfdg',
    openid: 'kjshfdjkdshkjsdh',
  },
  {
    KVDataList: [{key: 'score', value: '23'}],
    avatarUrl: url,
    nickname: 'dfgg',
    openid: 'kjshfdjkdshkjsdh',
  },
  ...
  {
    KVDataList: [{key: 'score', value: '657'}],
    avatarUrl: url,
    nickname: 'dfg',
    openid: 'kjshfdjkdshkjsdh',
  },
  {
    KVDataList: [{key: 'score', value: '68'}],
    avatarUrl: url,
    nickname: 'dfgfd',
    openid: 'kjshfdjkdshkjsdh',
  },
  {
    KVDataList: [{key: 'score', value: '687'}],
    avatarUrl: url,
    nickname: 'hg',
    openid: 'kjshfdjkdshkjsdh',
  },
  ...
  {
    KVDataList: [{key: 'score', value: '87'}],
    avatarUrl: url,
    nickname: '12ert131',
    openid: 'kjshfdjkdshkjsdh',
  },
  {
    KVDataList: [{key: 'score', value: '76'}],
    avatarUrl: url,
    nickname: 'qqw',
    openid: 'kjshfdjkdshkjsdh',
  },
...
function drawRankPanel () {
  ...
  context.drawImage (
    assets.panel,
    offsetX_rankToBorder,
    offsetY_rankToBorder,
    RankWidth,
    RankHeight
  );
...
function init () {
  ...
  startX = offsetX_rankToBorder + 50;
  startY = offsetY_rankToBorder + barHeight + 100;
  ...
  nextButtonY = lastButtonY =
    offsetY_rankToBorder + RankHeight - buttonHeight - 30;
...
function drawByData (data, i) {
  ...
  context.fillText (
    index.toString (),
    x - 8,
    startY + i * preOffsetY + textOffsetY + 4,
    textMaxSize
  );
  // }
  x += cupSize + 20;
  ...
  if (loadAvatarFail) {
    context.drawImage (
      assets.avatar,
      x,
      startY + i * preOffsetY + (barHeight - avatarSize) / 2,
      avatarSize,
      avatarSize
    );
  } else {
  ...
  context.fillText (
    data.name + '',
    x,
    startY + i * preOffsetY + textOffsetY,
    textMaxSize
  );
...
function onTouchEnd (event) {
  ...
  if (
    x > lastButtonX &&
    x < lastButtonX + buttonWidth &&
    y > lastButtonY &&
    y < lastButtonY + buttonHeight
  ) {
    //
    //在last按钮的范围内
...
function createScene () {
  ...
  if (sharedCanvas.width && sharedCanvas.height) {
    ...
    console.log (
      `sharedCanvas.width:${sharedCanvas.width}    sharedCanvas.height：${sharedCanvas.height}`
    );
  }
  init ();
