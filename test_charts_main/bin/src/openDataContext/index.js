 ...
 */
const assetsUrl = {
  icon: "src/openDataContext/assets/icon.png",
  box: "src/openDataContext/assets/box.png",
  panel: "src/openDataContext/assets/panel.png",
  button: "src/openDataContext/assets/button.png",
  title: "src/openDataContext/assets/rankingtitle.png"
};
...
function drawRankList(data) {
  data.forEach((item, index) => {
    ...
    let userData = {}
    userData.key = index
    userData.name = item.nickname
    userData.scroes = Math.random()*1000
    totalGroup.push(userData)
    // const img = wx.createImage();
    // img.src = item.avatarUrl
    // img.onload = (res) => {
    //   console.log(res)
    //   // userData.url = item.avatarUrl
    //   // totalGroup.push(userData)
